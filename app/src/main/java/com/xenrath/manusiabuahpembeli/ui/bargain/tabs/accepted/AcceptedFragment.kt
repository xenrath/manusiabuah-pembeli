...
class AcceptedFragment : Fragment(), AcceptedContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: AcceptedPresenter
    ...
    override fun onCreateView(
        ...
        presenter = AcceptedPresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.getBargainAccepted(prefManager.prefId.toString(), "Diterima")
    }
