package com.xenrath.manusiabuahpembeli.ui.product.update
...
import com.xenrath.manusiabuahpembeli.ui.product.ProductMapsActivity
...
//                )
    ...
    override fun onResultDetail(responseProductDetail: ResponseProductDetail) {
        ...
        GlideHelper.setImage(this, product.image!!, iv_user_image)

        tv_total_item.setText(product.stock)
    }
